const TopRightSprinkles = () => {
  return (
    <div className="su-absolute su-w-[325px] su-max-w-full lg:su-w-[650px] su-h-[175px] lg:su-h-[350px] su-top-0 su-right-0">
...
const TopLeftSprinkles = () => {
  return (
    <div className="su-absolute su-w-[325px] su-max-w-full lg:su-w-[650px] su-h-[175px] lg:su-h-[350px] su-top-0 su-left-0">
...
const BottomLeftSprinkles = () => {
  return (
    <div className="su-absolute su-w-[325px] su-max-w-full lg:su-w-[650px] su-h-[175px] lg:su-h-[350px] su-bottom-0 su-left-0">
...
const BottomRightSprinkles = () => {
  return (
    <div className="su-absolute su-w-[325px] su-max-w-full lg:su-w-[650px] su-h-[175px] lg:su-h-[350px] su-bottom-0 su-right-0">

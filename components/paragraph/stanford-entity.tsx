      ...
      <div ref={centeredRef} className={wrapperClasses}>
        ...
        {entities &&
          <div className={"su-mb-40 su-grid su-gap-2xl " + gridCols} aria-live="polite">
            {entities.map((item, i) =>
              <div key={item.id}
                   className={((i + 1 === entities.length || i + 1 % 3 === 0) ? " su-w-full lg:su-max-w-[980px] su-mx-auto" : "su-relative before:su-content-[''] before:su-w-1 before:su-absolute before:su-top-0 before:su-h-full before:su-right-[-25px] lg:before:su-bg-black-30")}>

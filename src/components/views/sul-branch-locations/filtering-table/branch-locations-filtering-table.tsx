...
const TableRow = ({id, imageUrl, path, title, phone, email, mapUrl, address, hoursId}: BranchLocation) => {
  return (
    ...
    >
      ...
      <Td className="block w-auto sm:border-b sm:border-black-40 lg:table-cell lg:w-1/4 lg:pr-20 lg:align-middle xl:pr-80">
        {phone && (
          <a
            ...
            className="m-auto flex w-fit items-center justify-center gap-4 text-16 font-normal leading-cozy no-underline hover:bg-black-10 hover:text-brick-dark hover:underline focus:bg-none md:m-[unset] md:justify-start"
          >
        ...
        {email && (
          <a
            href={`mailto:${email}`}
            className="m-auto mb-16 flex w-fit items-center justify-center gap-4 text-16 font-normal leading-cozy no-underline hover:bg-black-10 hover:text-brick-dark hover:underline focus:bg-none md:mx-[unset] md:justify-start lg:mb-0"
          >
      ...
      <Td className="block w-auto text-16 leading-cozy sm:border-b sm:border-black-40 lg:table-cell lg:w-1/4 lg:align-middle">
        {address && mapUrl && (
          <div className="pb-16 lg:pb-0">

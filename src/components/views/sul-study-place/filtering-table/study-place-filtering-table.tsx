              ...
              <fieldset className="mb-10 mr-0 flex h-25 w-full items-center md:mb-0 md:mr-10">
                ...
                <label className="group cursor-pointer">
                  <input
                    ...
                    checked={onlyOpenNow}
                  />
                  <span className="flex items-center whitespace-nowrap rounded-r-full border border-black-80 p-9 pr-20 text-18 text-black-80 no-underline group-hover:text-cardinal-red-dark group-hover:underline peer-checked:bg-[#979694] peer-checked:bg-opacity-20 peer-checked:pl-16 peer-checked:text-black peer-checked:transition-all peer-checked:ease-in-out peer-focus:border-2 peer-focus:border-black-80 peer-focus:bg-[#979694] peer-focus:bg-opacity-10 peer-focus:text-black peer-checked:[&_svg]:text-black">
                    <CheckIcon width={20} className="text-transparent" />
                    Open now
                  </span>
                </label>

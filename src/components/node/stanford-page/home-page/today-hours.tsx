        ...
        footer={
          <div className="relative pb-100 md:rs-pb-6">
            <div className="absolute w-full">
              ...
              {library?.map &&
                <span className="float-right w-auto inline"><Link href={library?.map} ><span className="sr-only">{library.title}&nbps;</span><MapPinIcon title="Map" width={25} className="mr-5 inline"/>Location</Link></span>
              }
            </div>
          </div>
        }

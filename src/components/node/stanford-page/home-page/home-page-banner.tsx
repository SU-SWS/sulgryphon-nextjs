    ...
    <header className="relative mb-50 bg-black-true">
        ...
        <div className="justify-between md:flex xl:mx-20">
          <div className="mb-40 text-white md:w-1/3 lg:w-1/2">
            ...
            <p>
              ...
              ,{" "}
              <Link
                href="https://exhibits.stanford.edu/"
                className="text-white hocus:text-white hocus:no-underline"
              >
                online exhibits
              </Link>
              , and{" "}
              <Link
                href="https://earthworks.stanford.edu/"
                className="text-white hocus:text-white hocus:no-underline"
              >
                EarthWorks
              </Link>
          ...
          <TodayHours
            libraries={trimmedLibraries}
            className="z-100 relative md:min-w-[300px] xl:min-w-[400px]"
          />
        </div>
      </div>
      ...
      <div className="absolute bottom-0 right-0 h-2/3 w-3/4 bg-right-bottom lg:bg-home-banner-sprinkles">
        <div className="absolute h-full w-full bg-gradient-to-b from-black-true to-transparent">
          <div className="absolute h-full w-full bg-gradient-to-r from-black-true to-transparent">{/*Empty elements. They are absolute positioned to provide visual affects only.*/}</div>
        </div>
      </div>
